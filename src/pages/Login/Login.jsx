...
const Login = () => {
    return (
        ...
        <div className="mb-16 text-center">
          <img src={logo} className='w-[203px] h-[60px]' alt="" />
        </div>
          ...
          <div className="col-span-2 lg:col-span-1 py-10 px-10">
            ...
            <form  className="flex flex-col items-center justify-center" >
              ...
              <span className="pl-2 pr-4 border-r border-gray-200">
                ...
                {/* Button Login */}
                <button type="submit" className="px-28  py-3 mb-2 rounded-lg bg-yellow-400 text-white font-semibold tracking-wider uppercase transition duration-150 transform hover:scale-105 hover:bg-yellow-500">Login</button>
